...
import {
  ...
  Download, User, ChevronLeft, ChevronRight, Scan, LogOut,
} from 'lucide-react'
...
const nav = [
  ...
  { href: '/user/attendance',  icon: ClipboardList,   label: 'My Attendance'},
  { href: '/user/statistics',  icon: BarChart3,       label: 'Statistics'   },
  { href: '/user/export',      icon: Download,        label: 'Export'       },
        ...
        <AnimatePresence>
          {!collapsed && (
            ...
            >
              ...
              <p className="text-xs text-emerald-400">User Portal</p>
            </motion.div>
          )}
        </AnimatePresence>
      </div>
          ...
          {!collapsed && (
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-zinc-600 truncate">{user?.employee_id ?? user?.email}</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
